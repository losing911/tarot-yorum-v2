...
define('APP_URL', 'https://tarot-yorum.fun'); // Change to your domain
...
// Security settings
define('SECRET_KEY', 'your-super-secret-key-change-this-in-production'); // Change this!
...
define('MAIL_PASSWORD', 'your-app-password'); // Change this
define('MAIL_FROM_EMAIL', 'noreply@tarot-yorum.fun');
